...
//		cout << "before protocol judge" << endl;
		...
		rcv_size = loopedReceive(sock, srecv, recvAddr, 0, TCP);
...
int ZHTClient::compare_and_swap2(string str) {
	Package package;
	package.ParseFromString(str);
...
int ZHTClient::compare_and_swap(string str, string &returnStr) {
